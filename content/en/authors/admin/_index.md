...
bio: My research interests include open quantum theory, quantum information, artificial intelligence.

# Interests to show in About widget
interests:
- Open Quantum Theory (HEOM)
- Quantum Qumputation
- Artificial Intelligence
- Scientifical Computation

# Education to show in About widget
education:
  courses:
  - course: Ph.D. in Condensed Physics
...
- icon: stackoverflow
  icon_pack: ai
  link: https://stackoverflow.com/users/7522764/peace-wang
- icon: graduation-cap  # Alternatively, use `google-scholar` icon from `ai` icon pack
  icon_pack: fas
  link: https://scholar.google.com/citations?user=eUiVm18AAAAJ
- icon: github
  icon_pack: fab
  link: https://github.com/qiangua
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.cn/injobs/in/qianlong-wang-97484695
